                                                                                    ...
                                                                                    <td valign="middle" style='vertical-align: middle;'>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                                                                                                <h1 class='big'><a target='_blank' href="" style='color:#444444'>BetaCaracois</a></h1>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style=''>
                                                                                                <h2 style="font-size: 20px;">Hello {{$email_data['name']}} Your Account has been Created</h2>
                                                                                                <br>
                                                                                                <p>
                                                                                                ...
                                                                                                <p>
                                                                                                    Login Email:  {{$email_data['email']}}
                                                                                                </p>
                                                                                                @endif
                                                                                                @if(isset($email_data['password']))
                                                                                                <p>
                                                                                                    Login Password:  {{$email_data['password']}}
                                                                                                </p>
                                                                                                <br>
                                                                                                <br>
                                                                                                <strong>Change your Password After Login !!</strong>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                                <p>Copyright © BetaCaracois {{date('Y')}}. All rights reserved.</p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
