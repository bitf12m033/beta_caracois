	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="kt-portlet">
			    ...
			    @endif
				<!--begin::Form-->
				<form class="kt-form kt-form--label-right" method="POST" action="{{ route('users.update',$user->id) }}">
					@csrf
					@method('PUT')
					<div class="kt-portlet__body">
						<div class="form-group row">
							...
							<div class="col-lg-4">
								...
								<input type="email" id="email" value="{{$user->email}}" name="email" class="form-control" placeholder="Enter email">
						...
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<div class="input-group date">
									<input type="text" name="dob" class="form-control" readonly value="{{$user->dob}}" id="dob" />
