					...
					<div class="kt-portlet__body">
						...
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<div class="input-group date">
									<input type="text" name="receive_date" class="form-control" readonly value="{{\Carbon\Carbon::now()->format('d/m/Y')}}" id="receive_date" />
							...
							<div class="col-lg-4">
								...
								<div class="input-group date">
									<input type="text" name="expired_date" class="form-control" readonly value="{{\Carbon\Carbon::now()->format('d/m/Y')}}" id="expired_date" />
									<div class="input-group-append">
										<span class="input-group-text">
											<i class="la la-calendar"></i>
										</span>
							...
							<div class="col-lg-4">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="original_price" name="original_price" class="form-control" placeholder="Fax number">
						...
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="sell_price" name="sell_price" class="form-control" placeholder="Enter sell price">
									<span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i class="la la-dollar"></i></span></span>
								</div>
