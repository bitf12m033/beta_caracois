			...
			columnDefs: [
				{
					...
					render: function(data, type, full, meta) {
						...
						var product_image = full.product_image?full.product_image:'uploads/product/default.png';
							...
							output = `
                                <div class="kt-user-card-v2">
                                    <div class="kt-user-card-v2__pic">
                                        <img src="` + product_image + `" class="m-img-rounded kt-marginless" alt="photo">
                                    </div>
                                    <div class="kt-user-card-v2__details">
                                        <span class="kt-user-card-v2__name">` + full.product_name + `</span>
...
$('#kt_modal_product_delete form').attr("action","products/"+id);


$("#kt_modal_product_delete").modal("show");
}